...
//const char* IpAddr;
const char* Version = "NewBuild_1J";
#ifdef Wemos
...
void callback(String topic, byte* message, unsigned int length) {
  ...
  if (topic == "wemosTestClient/setSleepTime") {
    Serial.println("Matched on wemosTestClient/setSleepTime");
    if (messageTemp == "60") {
      Serial.println("changing sleeptime to 60");
      //ESP.restart();
  ...
  while (!client.connected()) {
    ...
    */
    if (client.connect("TbOfficeClient")) {
      ...
      client.subscribe("TbOfficeClient/SleepTime");
    } else {
     ...
     //Find Me
     if (client.connect("wemosTestClient")) {
      Serial.println(F("connected to wemosTestClient"));
      //client.subscribe("wemosTestClient/LcdState");
      //client.subscribe("wemosTestClient/reset_ESP");
